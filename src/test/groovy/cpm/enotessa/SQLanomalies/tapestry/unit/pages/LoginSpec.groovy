package cpm.enotessa.SQLanomalies.pages
...
import cpm.enotessa.SQLanomalies.services.QaModule
...
class LoginSpec extends Specification {
    ...
    def setupSpec() {
        tester = new TapestryTester("cpm.enotessa.SQLanomalies", "app", "src/main/webapp", QaModule.class)
    }
